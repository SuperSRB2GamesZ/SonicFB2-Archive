...
// Unfortunately, this can no longer be saved.. no it can you stoopid idiot
consvar_t cv_grfiltermode = { "gr_filtermode", "Nearest", CV_SAVE | CV_CALL, grfiltermode_cons_t, CV_filtermode_ONChange};
